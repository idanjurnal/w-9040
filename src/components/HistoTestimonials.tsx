...
const HistoTestimonials = () => {
  ...
  return <section id="testimonials" className="py-20 relative overflow-hidden bg-gradient-to-br from-stone-50 via-amber-50 to-orange-50">
      <div className="absolute inset-0 z-0">
        <img src="/lovable-uploads/06849598-4d8a-4553-a9fc-eb2a862f976f.png" alt="Elegant botanical pattern background" className="w-full h-full object-cover" />
                  ...
                  <div className="bg-white/70 backdrop-blur-sm rounded-lg shadow-sm border border-stone-200/50 overflow-hidden mx-4 p-8 group hover:shadow-amber-200 transition-shadow duration-300 hover:scale-[1.02]">
                    <div className="text-center">
                      ...
                      <div className="flex justify-center items-center mb-6">
                        {[...Array(testimonial.rating)].map((_, i) => <Star key={i} className="w-5 h-5 text-amber-500 fill-current mx-1" />)}
                      </div>
